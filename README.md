...
Run notebooks in order. Each notebook is **fully self-contained** with no
cross-notebook dependencies — all data loading, preprocessing and analysis
is done within each notebook.

| Notebook | Purpose | Est. Runtime |
|----------|---------|-------------|
| `00_data_exploration.ipynb` | EDA, distributions, missingness | ~2 min |
| `01_preprocessing_frailty.ipynb` | Full preprocessing pipeline | ~3 min |
| `02_RQ1_SP_residence_moderation.ipynb` | RQ1 statistical analysis | ~5 min |
| `03_RQ2_SP_comorbidity_moderation.ipynb` | RQ2 statistical analysis | ~5 min |
| `04_RQ3_SP_depression_moderation.ipynb` | RQ3 statistical analysis | ~5 min |
| `05_RQ4_rurality_malnutrition.ipynb` | RQ4 statistical analysis | ~5 min |
| `06_ML_frailty_prediction.ipynb` | Train and evaluate 4 ML models | ~10 min |
| `07_SHAP_feature_importance.ipynb` | SHAP explainability analysis | ~5 min |
| `08_SP_logistic_regression.ipynb` | SP binary classification + ROS | ~3 min |
| `09_SP_linear_regression.ipynb` | SP score linear regression | ~3 min |
...
| Reporting | `IPython.display`, HTML |
...
```bibtex
@software{yourname2026frailty,
  author    = {Your Last Name, Your First Name},
  title     = {Capstone Project: Frailty Prediction, Social Participation
               and Malnutrition Analysis in Older Adult Americans},
  year      = {2026},
  publisher = {GitHub},
  url       = {https://github.com/YOUR_USERNAME/Capstone-Project}
}
```
